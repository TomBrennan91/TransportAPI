...
- Easily Extensible: If a new means of transportation comes along, simply make a new class that extends the Ticket Class.
  ...
  transport can then be added by overriding the constructor. Because we use JSON as our input, none of the input data
  or any of the other ticket classes need to be modified.
...
- Homebrew Json Parser: I decided to use JSON as an input format as it is the most realistic real world input for a web-app.
